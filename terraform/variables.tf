...
variable "use_existing_resource_group" {
  description = "Reuse an existing resource group instead of creating one"
  type        = bool
  default     = false
}

variable "grant_acr_pull_role" {
  description = "Create the AcrPull role assignment for AKS (requires Owner or User Access Administrator)"
  type        = bool
  default     = true
}
